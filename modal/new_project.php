...
<div class="modal fade bs-example-modal-lg-new text-center" tabindex="-1" role="dialog" aria-hidden="true">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form class="form-horizontal form-label-left input_mask" method="post" id="add" name="add">
                    ...
                    <div class="form-group">
                        <div class="col-md-9 col-sm-9 col-xs-12">
                            <textarea name="description" class="date-picker form-control col-md-7 col-xs-12" placeholder="Descripción" required></textarea>
                        </div>
                    </div>
